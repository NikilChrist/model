  ...
  return (
    <section className='features-section bg-light' id='features'>
      <div className='container'>
        <SectionTitle title='Why Use Coconut Coir Pith?' subtitle='It is an excellent soil conditioner and is being extensively used as a soil-less medium for agri-horticultural purposes.' />
